    ...
    <section className="w-full h-full flex items-center justify-center">
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-stretch">
          ...
          {/* Portrait */}
          <div className="relative w-full md:w-64 flex-shrink-0 self-stretch aspect-[3/4] md:aspect-auto rounded-lg border border-accent-amber/30 transition duration-100 hover:border-accent-amber hover:shadow-lg hover:shadow-accent-amber/50 overflow-hidden">
            <img
              src={headshot}
          ...
          {/* About Me Card */}
          <div className="bg-card rounded-lg p-8 border border-border flex-1 transition duration-100 hover:border-accent-amber hover:shadow-lg hover:shadow-accent-amber/50">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-accent-amber/10 rounded-lg">
                <UserRound className="w-8 h-8 text-accent-amber" />
              </div>
